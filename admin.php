...
<input type="hidden"
       name="member_id"
       value="<?php echo $edit_member['id']; ?>">

<label>Member Name</label>

<input type="text"
       name="member_name"
       value="<?php echo htmlspecialchars($edit_member['member_name']); ?>"
       required>
...
<input type="text"
       name="designation"
       value="<?php echo htmlspecialchars($edit_member['designation']); ?>"
       required>
...
<input type="text"
       name="icon"
       value="<?php echo htmlspecialchars($edit_member['icon']); ?>">
...
<a class="action"
href="admin.php?edit_member=<?php echo $member['id']; ?>">
Edit
</a>

<a class="action delete"
href="admin.php?delete_member=<?php echo $member['id']; ?>"
...
<input type="hidden"
       name="gallery_id"
       value="<?php echo $edit_gallery['id']; ?>">
...
<a class="action"
   href="admin.php?edit_gallery=<?php echo $image['id']; ?>">
   Edit
</a>

<a class="action delete"
   href="admin.php?delete_gallery=<?php echo $image['id']; ?>"
...
<input type="text" name="client_name"
       value="<?php echo htmlspecialchars($edit_client['client_name']); ?>"
       required>
</div>
...
<input type="text" name="cnic"
       value="<?php echo htmlspecialchars($edit_client['cnic']); ?>">
</div>
...
<option <?php if ($edit_client['service']=="Legal Services") echo "selected"; ?>>
Legal Services
</option>

<option <?php if ($edit_client['service']=="Tax Consultation") echo "selected"; ?>>
Tax Consultation
</option>

<option <?php if ($edit_client['service']=="Corporate Services") echo "selected"; ?>>
Corporate Services
</option>

<option <?php if ($edit_client['service']=="Documentation Services") echo "selected"; ?>>
...
<input type="number" name="total_fee"
       step="0.01"
       value="<?php echo $edit_client['total_fee']; ?>"
       required>
</div>
...
<option value="Active"
<?php if ($edit_client['status']=="Active") echo "selected"; ?>>
Active
</option>

<option value="Inactive"
<?php if ($edit_client['status']=="Inactive") echo "selected"; ?>>
Inactive
</option>
...
<a class="action"
href="admin.php?resolve_query=<?php echo $query['id']; ?>">
Resolve
</a>
...
<a class="action delete"
href="admin.php?delete_query=<?php echo $query['id']; ?>"
...
<a class="action"
href="admin.php?edit=<?php echo $row['id']; ?>">
Edit
</a>
